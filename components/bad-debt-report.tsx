...
export function BadDebtReport({ items }: { items: any[] }) {
  ...
  return (
    <div className="rounded-[2rem] border border-red-500/30 bg-red-500/[0.03] backdrop-blur-xl overflow-hidden shadow-2xl shadow-red-500/5">
      <div className="p-6 border-b border-red-500/20 bg-red-500/10 flex items-center justify-between">
        ...
        <Badge className="bg-red-500 text-white font-black text-[9px] uppercase tracking-widest px-3 border-none">
      ...
      <div className="divide-y divide-red-500/10">
        {badDebts.map((debt) => (
          <div
            key={debt.id}
            className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 transition-colors hover:bg-red-500/5"
          >
            ...
            >
              <IconBrandWhatsapp size={18} strokeWidth={2.5} /> Execute
              Collection
            </Button>
          </div>
        ))}
